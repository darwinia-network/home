...
const CommunityTypewriter = () => {
  ...
  const fakeTitle = getFakeTitle(t(localeKeys.welcomeToDarwiniaCommunity));
  return (
...
export default CommunityTypewriter;
