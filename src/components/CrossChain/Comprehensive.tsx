    ...
    <section className="flex-col lg:flex-row flex items-center gap-[5rem] justify-center py-[6.25rem] bg-white px-[0.625rem]">
      ...
      <div className="flex flex-col items-center justify-center lg:block">
        ...
        <TitleAndTextSection
          ...
          classes="lg:w-[21.5rem] 2xl:w-[34.375rem]"
        />
        <a href="https://msgport.xyz" target="blank" className="flex w-fit items-center gap-[0.625rem] text-[0.875rem] text-[#F6F6F7] leading-[1.375rem] tracking-[0.063rem] py-[0.625rem] px-[0.938rem] bg-black z-10 rounded-[6.25rem] mt-[1.25rem] font-[700] transition-all delay-75 hover:bg-[#FF0083]">
          Learn more
