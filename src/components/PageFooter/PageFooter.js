                    ...
                    <Row className={`d-flex justify-content-center`}>
                        ...
                        <Col xs={6} md={4} lg={2}>
                            ...
                            {i18n.language.indexOf('en') > -1 ?
                                <p><a target="_blank" href="https://evolution.l2me.com/darwinia/Darwinia_Genepaper_EN_200430.pdf">{t('footer:technology_title_3')}</a></p>
                                :
                                <p><a target="_blank" href="https://evolution.l2me.com/darwinia/Darwinia_Genepaper_ZH_200430.pdf">{t('footer:technology_title_3')}</a></p>
                            }
                        </Col>
                        <Col xs={6} md={4} lg={2}>
