                ...
                <Navbar expand="lg" className={`${styles.Navbar} ${transparent ? null : styles.NavBg} cs-header`}>
                    ...
                    <Navbar.Collapse className={'d-none d-lg-block'}>
                        ...
                        <Form inline>
                            ...
                            href="https://evolution.l2me.com/darwinia/Darwinia_Genepaper_EN_200430.pdf">{t('header:genepaper')}</Nav.Link>
                            :
                            <Nav.Link target={'_blank'}
                            href="https://evolution.l2me.com/darwinia/Darwinia_Genepaper_ZH_200430.pdf">{t('header:genepaper')}</Nav.Link>
                            }
