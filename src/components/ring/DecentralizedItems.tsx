  ...
  return (
    <div className='flex items-center gap-[10px] lg:gap-0 lg:flex-col w-full bg-[#2A2A2A] lg:bg-transparent p-[10px] lg:p-0 rounded-[10px] lg:w-[104px]'>
        ...
        <div className='flex items-center gap-[5px]'>
            ...
            <img src="/images/ring/UnionBridge.svg" alt="union" className='hidden lg:block cursor-pointer' onClick={() => {
        ...
        </div>
        {
          ...
          <img src="/images/ring/UnionBridge.svg" alt="union" className='lg:hidden cursor-pointer'  onClick={() => {
                window.open(item.link, '_blank');
          }}/>
    </div>
  )
