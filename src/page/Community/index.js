                ...
                <Col md={10} xs={12} className={`${styles.content}`}>
                  ...
                  <div className={`${styles.mediaBlocks}`}>
                    <a
                      ...
                      className={`${styles.mediaBlock} ${styles.twitter}`}
                    >
                    ...
                    <a
                      ...
                      className={`${styles.mediaBlock} ${styles.telegram}`}
                    >
                      <div className={styles.mediaLogo}>
                    ...
                    <a
                      ...
                      className={`${styles.mediaBlock} ${styles.medium}`}
                    >
                      <div className={styles.mediaLogo}>
                    ...
                    <a
                      ...
                      className={`${styles.mediaBlock} ${styles.github}`}
                    >
                      <div className={styles.mediaLogo}>
                    ...
                    <div className={"text-center"}>
                      ...
                      <div className={styles.buttons}>
                        <Button
                          variant="transparent"
                          target="_blank"
                          href={t("community:darwinia_wiki_link")}
                          className={styles.button}
                        >
                          {t("community:darwinia_wiki")}
                        </Button>
                        <Button
                          variant="transparent"
                          target="_blank"
                  ...
                  <MediaQuery minDeviceWidth={768}>
                    <div className={`hidden-xs ${styles.persons}`}>
                      ...
                      {showMore ? (
                        ...
                        <img
                          alt="person"
                          className={`${styles.personMore}`}
                          src={person_more}
                          onClick={() => this.showMoreAvatar()}
                        />
                      )}
                    </div>
                  </MediaQuery>
