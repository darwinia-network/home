        ...
        <div className={cx('content')}>
          ...
          <div className={cx('item-wrap')}>
            ...
            <div className={cx('item')}>
              ...
              <p className={cx('item-desc')}>The package will be awarded immediately after the second round auction is terminated regardless of whether Darwinia Network wins the slot auction or not.</p>
            </div>
          </div>
        </div>
      </div>
