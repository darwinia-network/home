      ...
      <div className={cx('main')} id="waitlist-section">
        ...
        <div className={cx('right-part')}>
          ...
          <div className={cx('contact-list')}>
            <a rel='noopener noreferrer' target='_blank' className={cx('contact-link')} href='https://twitter.com/DarwiniaNetwork'>
              <img alt='...' src={twitterIcon} />
            </a>
            <a rel='noopener noreferrer' target='_blank' className={cx('contact-link')} href='https://darwinianetwork.medium.com/'>
              <img alt='...' src={mediumIcon} />
            </a>
            <a rel='noopener noreferrer' target='_blank' className={cx('contact-link')} href='https://t.me/DarwiniaNetwork'>
              <img alt='...' src={telegramIcon} />
            </a>
            <a rel='noopener noreferrer' target='_blank' className={cx('contact-link')} href='https://discord.com/channels/456092011347443723/795384466930663434'>
