  ...
  const itemData = [
    {
      icon: icon01,
      title: 'Preparation',
      describe: 'The DOT used for participation must be unbonded, that is, not locked for any reason (including staking, vesting, and governance). You need to unbond your DOT before the crowdloan.',
    },
    {
      icon: icon02,
      title: 'Contribution',
